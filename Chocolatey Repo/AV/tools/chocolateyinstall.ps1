$packageName = 'av'
$fileType = 'exe'
$fileLocation = "\\av\AV Clients\PC's\PC_WIN64BIT\Symantec Endpoint Protection version 14.0.2349.0100 - English\setup.exe"
$silentArgs = '/q[n]'
...
$packageName= 'AV' # arbitrary name for the package, used in messages
#$toolsDir   = "C:\Users\clafleur\Documents\PC_WIN64BIT\Symantec Endpoint Protection version 14.0.2349.0100 - English\"
...
$packageArgs = @{
  ...
  #url           = $url
  #url64bit      = $url64
  file         = "\\av\AV Clients\PC's\PC_WIN64BIT\Symantec Endpoint Protection version 14.0.2349.0100 - English\setup.exe"

  softwareName  = 'Symantec Endpoint Protection' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique

  # Checksums are now required as of 0.10.0.
  # To determine checksums, you can get that from the original site if provided. 
  # You can also use checksum.exe (choco install checksum) and use it 
  # e.g. checksum -t sha256 -f path\to\file
  checksum      = 'D3CD3E7AA67C67C564F1F695258E5EB4D27F55C7E41B46672E015207F5C692B2'
  checksumType  = 'sha256' #default is md5, can also be sha1, sha256 or sha512
  checksum64    = 'D3CD3E7AA67C67C564F1F695258E5EB4D27F55C7E41B46672E015207F5C692B2'
